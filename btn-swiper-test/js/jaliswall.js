            ...
            function print() {
                ...
                for (var i in elemsDatas) {
                    ...
                    if(i < nbCols) {
                       ...
                       hArr.push($(container.children(prm.columnClass)[i]).height());
                    } else {
                         var minH = Math.min.apply(null, hArr);
                         var minIndex = getIndex(minH, hArr);
                         container.children(prm.columnClass).eq(minIndex).append(html);
                         hArr[minIndex] = $(container.children(prm.columnClass)[minIndex]).height();
                    }
